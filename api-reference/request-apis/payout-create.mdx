---
title: 'Payout > Create'
description: 'Create the payout order.'
---
...
| callback_url   | string         | Yes      | Callback URL, If funds are successfully received, refer to [Callback > Payout](/api-reference/callback/payout) section for callback details.     |
